...
(function () {
    koockoo.locale.en = {
        reload: function () {
            ...
            Ext.define("Ext.locale.en.view.login.Login", {
            ...
            Ext.define("Ext.locale.en.view.main.Main", {
            ...
            Ext.define("Ext.locale.en.view.pending.Pending", {
                override: "OP.view.pending.Pending",

                formTitle : 'Pending Requests'
            });

            Ext.define("Ext.locale.en.view.chat.Chat", {
