 ...
 * Russian translation
 */
koockoo.locale = koockoo.locale || {};
(function () {
    koockoo.locale.ru = {
        reload: function () {

            Ext.define("Ext.locale.ru.view.login.Login", {
                override: "OP.view.login.Login",
                ...
                loginTip: "Как правило, ваш email"
            });

            Ext.define("Ext.locale.ru.view.main.Main", {
                override: "OP.view.main.Main",

                logoutLabel: "Выход",
                mainTabTitle: "Главная"
            });

            Ext.define("Ext.locale.ru.view.pending.Pending", {
                override: "OP.view.pending.Pending",

                formTitle : 'Очередь Запросов'
            });

            Ext.define("Ext.locale.ru.view.chat.Chat", {
                override: "OP.view.chat.Chat",
